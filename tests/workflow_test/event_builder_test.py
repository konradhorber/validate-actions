...
"""
    ...
    assert isinstance(
      pull_request_event,
      validate_actions.workflow.PathsBranchesFilterEvent
    )
...
"""
    ...
    assert isinstance(
      push_event, validate_actions.workflow.TagsPathsBranchesFilterEvent
    )
...
"""
    ...
    assert isinstance(
      workflow_call_event,
      validate_actions.workflow.WorkflowCallEvent
    )
    ...
    assert inputs[0].type_ == (
        validate_actions.workflow.WorkflowCallInputType.string
    )
...
"""
    ...
    assert isinstance(
      workflow_run_event,
      validate_actions.workflow.WorkflowRunEvent
    )
...
"""
    ...
    assert isinstance(
      ...
      validate_actions.workflow.WorkflowDispatchEvent
    )
