...
from validate_actions.pipeline_stages.builders.shared_components_builder import SharedComponentsBuilder
...
class TestSharedComponentsBuilderEnv:
    ...
    def test_build_env_with_valid_string_values(self):
        ...
        problems = Problems()
        builder = SharedComponentsBuilder(problems)
    ...
    def test_build_env_with_invalid_values_reports_errors(self):
        ...
        env_vars = {
            ast.String("INVALID", Pos(1, 1, 0)): {"nested": "dict"}
        }
