...
class TestEventsBuilder:
    def test_build_event_schedule_single(self):
        workflow_string = """
    on:
      schedule:
        - cron: '0 0 * * *'
    ...
    def test_build_event_schedule_list(self):
        workflow_string = """
    on:
      schedule:
        - cron: '0 0 * * *'
    ...
    def test_build_event_pull_request(self):
        workflow_string = """
    on:
      pull_request:
        branches: [main, dev]
    ...
    def test_build_event_push(self):
        workflow_string = """
    on:
      push:
        branches:
    ...
    def test_build_event_workflow_call(self):
        workflow_string = """
    on:
      workflow_call:
        inputs:
    ...
    def test_build_event_workflow_run(self):
        workflow_string = """
    on:
      workflow_run:
        workflows: [main]
    ...
    def test_build_event_workflow_dispatch(self):
        workflow_string = """
    on:
      workflow_dispatch:
        inputs:
