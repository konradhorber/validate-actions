...
class TestTagFetching:
    ...
    def setup_method(self):
        ...
        from validate_actions.rules.support_functions import get_current_action_version_cache
    ...
    def test_get_current_action_version_success(self):
        ...
        with patch('validate_actions.rules.support_functions.SESSION.get', return_value=mock_response):
...
class TestVersionParsing:
    ...
    def test_parse_partial_versions(self):
        ...
        from validate_actions.rules.support_functions import parse_semantic_version
        assert parse_semantic_version("v4.2") == (4, 2, 0)
        assert parse_semantic_version("v4") == (4, 0, 0)
        assert parse_semantic_version("4") == (4, 0, 0)
