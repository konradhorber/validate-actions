...
from validate_actions.analyzing.support_functions import get_current_action_version
...
class TestTagFetching:
    ...
    def test_get_current_action_version_success(self):
        ...
        with patch(
            "validate_actions.analyzing.support_functions.SESSION.get", return_value=mock_response
        ):
...
class TestVersionParsing:
    ...
    def test_parse_full_semantic_version(self):
        ...
        from validate_actions.analyzing.support_functions import parse_semantic_version
...
class TestVersionComparison:
    ...
    def test_major_version_outdated(self):
        ...
        from validate_actions.analyzing.support_functions import compare_semantic_versions
...
class TestCommitShaDetection:
    ...
    def test_commit_sha_detection(self):
        ...
        from validate_actions.analyzing.support_functions import is_commit_sha
...
class TestGetActionTags:
    ...
    def test_get_action_tags_returns_all_tags(self):
        ...
        with patch(
            ...
            from validate_actions.analyzing.support_functions import get_action_tags
    ...
    def test_resolve_partial_version_to_latest(self):
        ...
        with patch(
            ...
            from validate_actions.analyzing.support_functions import resolve_version_to_latest
