...
def test_job_outputs_input_match():
    ...
    rule = analyze.ExpressionsContexts(workflow_matches, False, None)
    ...
    rule = analyze.ExpressionsContexts(workflow_doesnt_match, False, None)
...
def test_fix_expression_context_typo():
    ...
    try:
        ...
        rule = analyze.ExpressionsContexts(workflow_obj, True, fixer)
